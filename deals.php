...
<div class="container" style="padding-top: 100px;">
    ...
    <div class="deals-hero">
        ...
        <p class="lead text-muted col-md-6 mx-auto">Đừng bỏ lỡ cơ hội sở hữu những cuốn sách tuyệt vời với mức giá tốt
            nhất.</p>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="promo-card">
                    ...
                    <p class="promo-description">Nhận ngay một sổ tay Giáng Sinh xinh xắn cho mọi đơn hàng trên
                        300.000đ.</p>
            ...
            <div class="col-lg-4 col-md-12 mx-auto">
                <div class="promo-card">
                    <div class="promo-icon" style="background-color: #3b82f6;"><i class="fas fa-shipping-fast"></i>
                    </div>
                    <h5 class="promo-title">Miễn phí vận chuyển</h5>
                    <p class="promo-description">Miễn phí giao hàng toàn quốc cho tất cả các đơn hàng trong dịp Giáng
                        Sinh.</p>
    ...
    <div class="deals-toolbar d-flex justify-content-between align-items-center">
        <span class="text-muted">Tìm thấy <strong><?php echo mysqli_num_rows($result); ?></strong> sản phẩm khuyến
            mãi</span>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" id="sortForm"
            ...
            <select name="sort" id="sortSelect" class="form-select form-select-sm"
                ...
                <option value="discount_desc" <?php if ($sort_option == 'discount_desc')
                    echo 'selected'; ?>>Giảm giá
                    nhiều nhất</option>
                ...
                <div class="col">
                    <div class="book-card-glass h-100 d-flex flex-column">
                        ...
                        <div class="book-img-wrapper">
                            <img src="<?php echo $path; ?>" alt="<?php echo htmlspecialchars($row['Title']); ?>"
                                onerror="this.src='https://placehold.co/400x600/eee/31343C?text=Book+Cover'">
                            <div class="action-overlay"> <a href="cart.php?ID=<?php echo $row['PID']; ?>&quantity=1"
                                    class="btn-icon" title="Thêm vào giỏ"><i class="fas fa-shopping-cart"></i></a>
                                <button onclick='openQuickView(<?php echo json_encode($row); ?>)' class="btn-icon"
                                    title="Xem nhanh"><i class="fas fa-eye"></i></button>
                                <button onclick="addToWishlist('<?php echo $row['PID']; ?>')" class="btn-icon"
                                    title="Yêu thích"><i class="fas fa-heart"></i></button>
                            </div>
                        </div>
