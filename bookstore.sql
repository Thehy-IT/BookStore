...
UPDATE `authors` SET `biography` = 'Dale Carnegie (1888-1955) là một nhà văn và nhà thuyết trình người Mỹ, người tiên phong trong lĩnh vực phát triển bản thân và kỹ năng giao tiếp. Cuốn sách "Đắc nhân tâm" của ông là một trong những cuốn sách bán chạy nhất mọi thời đại, đã giúp hàng triệu người cải thiện các mối quan hệ và đạt được thành công.' WHERE `name` = 'Dale Carnegie';
UPDATE `authors` SET `biography` = 'Jim Collins là một nhà nghiên cứu, tác giả và nhà tư vấn người Mỹ về quản trị kinh doanh. Ông nổi tiếng với các cuốn sách kinh điển như "Từ tốt đến vĩ đại" và "Xây dựng để trường tồn", trong đó ông phân tích các yếu tố giúp các công ty đạt được thành công vượt trội và bền vững.' WHERE `name` = 'Jim Collins';
UPDATE `authors` SET `biography` = 'Napoleon Hill (1883-1970) là một tác giả người Mỹ trong lĩnh vực tư duy thành công. Ông được biết đến nhiều nhất qua cuốn sách "Nghĩ giàu và làm giàu", một trong những cuốn sách truyền cảm hứng và có ảnh hưởng nhất về thành công cá nhân.' WHERE `name` = 'Napoleon Hill';
UPDATE `authors` SET `biography` = 'Eric Ries là một doanh nhân và tác giả người Mỹ, được biết đến là người khởi xướng phong trào "Khởi nghiệp tinh gọn" (Lean Startup). Phương pháp của ông đã thay đổi cách các công ty và doanh nhân xây dựng và phát triển sản phẩm mới.' WHERE `name` = 'Eric Ries';
UPDATE `authors` SET `biography` = 'J.K. Rowling là một tiểu thuyết gia người Anh, tác giả của bộ truyện giả tưởng "Harry Potter", bộ sách đã trở thành một hiện tượng văn học toàn cầu, bán được hơn 500 triệu bản và được dịch ra nhiều thứ tiếng. Bà là một trong những tác giả có ảnh hưởng nhất thế giới.' WHERE `name` = 'J.K. Rowling';
...
UPDATE `authors` SET `biography` = 'Phan Anh, hay còn được biết đến với biệt danh Esheep, là một blogger ẩm thực và tác giả sách nấu ăn nổi tiếng tại Việt Nam. Cô truyền cảm hứng cho tình yêu bếp núc qua những công thức sáng tạo và những câu chuyện ấm áp đằng sau mỗi món ăn.' WHERE `name` = 'Phan Anh (Esheep)';
UPDATE `authors` SET `biography` = 'Nam Cao (1917-1951) là một trong những nhà văn hiện thực xuất sắc nhất của văn học Việt Nam trước năm 1945. Các tác phẩm của ông, như "Chí Phèo", "Lão Hạc", đã khắc họa một cách sâu sắc bi kịch của người nông dân và trí thức nghèo trong xã hội cũ.' WHERE `name` = 'Nam Cao';
UPDATE `authors` SET `biography` = 'Ngô Tất Tố (1894-1954) là một nhà văn, nhà báo, nhà nghiên cứu văn hóa lớn của Việt Nam. Ông nổi tiếng với tiểu thuyết "Tắt đèn", một tác phẩm tiêu biểu của dòng văn học hiện thực phê phán, phơi bày sự cùng khổ của người nông dân dưới ách áp bức.' WHERE `name` = 'Ngô Tất Tố';
UPDATE `authors` SET `biography` = 'Thạch Lam (1910-1942) là một nhà văn lãng mạn nổi tiếng trong nhóm Tự Lực văn đoàn. Ông có sở trường về truyện ngắn và bút ký. Tác phẩm "Hà Nội băm sáu phố phường" của ông là những trang viết tinh tế, đầy chất thơ về vẻ đẹp và văn hóa của Hà Nội xưa.' WHERE `name` = 'Thạch Lam';
