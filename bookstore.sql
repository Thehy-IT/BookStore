...
UPDATE `authors` SET `biography` = 'Dale Carnegie (1888-1955) là một nhà văn và nhà thuyết trình người Mỹ, người tiên phong trong lĩnh vực phát triển bản thân và kỹ năng giao tiếp. Cuốn sách "Đắc nhân tâm" của ông là một trong những cuốn sách bán chạy nhất mọi thời đại, đã giúp hàng triệu người cải thiện các mối quan hệ và đạt được thành công.', `image_url` = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Dale_Carnegie_in_1920.jpg/220px-Dale_Carnegie_in_1920.jpg' WHERE `name` = 'Dale Carnegie';
UPDATE `authors` SET `biography` = 'Jim Collins là một nhà nghiên cứu, tác giả và nhà tư vấn người Mỹ về quản trị kinh doanh. Ông nổi tiếng với các cuốn sách kinh điển như "Từ tốt đến vĩ đại" và "Xây dựng để trường tồn", trong đó ông phân tích các yếu tố giúp các công ty đạt được thành công vượt trội và bền vững.', `image_url` = 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Jim_Collins_2012_Shankbone.JPG/220px-Jim_Collins_2012_Shankbone.JPG' WHERE `name` = 'Jim Collins';
UPDATE `authors` SET `biography` = 'Napoleon Hill (1883-1970) là một tác giả người Mỹ trong lĩnh vực tư duy thành công. Ông được biết đến nhiều nhất qua cuốn sách "Nghĩ giàu và làm giàu", một trong những cuốn sách truyền cảm hứng và có ảnh hưởng nhất về thành công cá nhân.', `image_url` = 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Napoleon_Hill_in_1922.jpg/220px-Napoleon_Hill_in_1922.jpg' WHERE `name` = 'Napoleon Hill';
UPDATE `authors` SET `biography` = 'Eric Ries là một doanh nhân và tác giả người Mỹ, được biết đến là người khởi xướng phong trào "Khởi nghiệp tinh gọn" (Lean Startup). Phương pháp của ông đã thay đổi cách các công ty và doanh nhân xây dựng và phát triển sản phẩm mới.', `image_url` = 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Eric_Ries_at_TechCrunch_Disrupt_SF_2011_%28cropped%29.jpg/220px-Eric_Ries_at_TechCrunch_Disrupt_SF_2011_%28cropped%29.jpg' WHERE `name` = 'Eric Ries';
UPDATE `authors` SET `biography` = 'J.K. Rowling là một tiểu thuyết gia người Anh, tác giả của bộ truyện giả tưởng "Harry Potter", bộ sách đã trở thành một hiện tượng văn học toàn cầu, bán được hơn 500 triệu bản và được dịch ra nhiều thứ tiếng. Bà là một trong những tác giả có ảnh hưởng nhất thế giới.', `image_url` = 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/J._K._Rowling_2010.jpg/220px-J._K._Rowling_2010.jpg' WHERE `name` = 'J.K. Rowling';
